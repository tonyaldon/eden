...
- You want to ask something to *ChatGPT*?  Call ~eden~ command, enter your
  ...
  #+html: <p align="center">
  #+html: <img src="https://raw.githubusercontent.com/tonyaldon/eden/master/demo.gif" />
  #+html: </p>
...
Also note that *Eden* keeps track of all your interactions with *ChatGPT*.
Each request is stored in the ~eden-dir~ directory, providing a range of
benefits:
